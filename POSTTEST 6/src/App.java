...
public class App {
    ...
    public static void main(String[] args) {
        while (true) {
            ...
            System.out.println("5. Lihat Total Transaksi");
            ...
            switch (pilihan) {
                ...
                case 3:
                    ...
                    break;
                case 5:
                    System.out.println("Total transaksi yang telah dilakukan: " + transaksi.getTotalTransaksi());
                    break;
                case 6:
        ...
        while (true) {
            ...
            switch (pilihan) {
                case 1:
                    ...
                    game g = new game(IDgame, Namagame, Devgame);
                    gameCRUD.tambah(g);
                    System.out.println("Deskripsi Singkat: " + g.deskripsiSingkat());
                    System.out.println("Deskripsi Lengkap: " + g.deskripsiLengkap());
                    break;
                case 2:
                    gameCRUD.lihat();
                    break;
            ...
            switch (pilihan) {
                case 1:
                    ...
                    try {
                        ...
                        produk p;
                        if (jenisProduk == produk.JenisProduk.DIAMOND) {
                            System.out.print("Masukkan Jumlah Diamond: ");
                            int jumlahDiamond = scanner.nextInt();
                            scanner.nextLine();
                            p = new produk.diamond(IDproduk, stok, harga, IDgame, jumlahDiamond);
                        } else if (jenisProduk == produk.JenisProduk.ITEM) {
                            System.out.print("Masukkan Durasi Item: ");
                            String durasiItem = scanner.nextLine();
                            p = new produk.item(IDproduk, stok, harga, IDgame, durasiItem);
                        } else {
                            throw new IllegalArgumentException("Jenis Produk tidak dikenali");
                        }
                        produkCRUD.tambah(p);
                ...
                case 2:
                    ...
                    System.out.println("2. Lihat Produk Diamond");
                    System.out.println("3. Lihat Produk Item");
                    System.out.print("Pilih opsi: ");
                    int opsiLihat = scanner.nextInt();
                    scanner.nextLine();
                    switch (opsiLihat) {
                        case 1:
                            produkCRUD.lihat();
                            break;
                        case 2:
                            produkCRUD.lihatByJenis(produk.JenisProduk.DIAMOND);
                            break;
                        case 3:
                            produkCRUD.lihatByJenis(produk.JenisProduk.ITEM);
                            break;
                        default:
    ...
    private static void menuTransaksi() {
        ...
        transaksi t = new transaksi(IDtransaksi, IDpelanggan, IDproduk, totalHarga);
        System.out.println("Transaksi berhasil dibuat: " + t);
    }
}
